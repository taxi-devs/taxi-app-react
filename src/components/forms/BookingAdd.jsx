...
export default function BookingAdd(props) {
    ...
    const handleSubmit = event => {
        ...
        axios.post('http://localhost:2000/add-booking', {
        ...
        <div className="addForm" >
            ...
            <form onSubmit={handleSubmit} onChange={handleInputChange}>
                ...
                <div>
                    ...
                    <select type="Text" id="dropoff_location" name="dropoff_location" onChange={handleInputChange} defaultValue="Airport">
                        <option value="Airport">Airport</option>
                        <option value="Vision City">Vision City</option>
                        <option value="Gerehu">Gerehu</option>
                        <option value="Boroko">Boroko</option>
                ...
                <div>
                    ...
                    <select type="Text" id="car" name="car" onChange={handleInputChange} defaultValue="Toyota Mark II">
